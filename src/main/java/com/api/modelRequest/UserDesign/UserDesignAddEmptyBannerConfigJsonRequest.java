...
public class UserDesignAddEmptyBannerConfigJsonRequest {
	
	private String AppID;
	private String DefaultLanguage;
	private UserDesignUserDesignJSON UserDesignJSON;
	private UserDesignEmptyBannerConfigJSON BannerConfigJSON;
	...
	public UserDesignEmptyBannerConfigJSON getBannerConfigJSON() {
		return BannerConfigJSON;
	}

	public void setBannerConfigJSON(UserDesignEmptyBannerConfigJSON BannerConfigJSON) {

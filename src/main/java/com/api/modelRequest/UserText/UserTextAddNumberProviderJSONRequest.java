...
public class UserTextAddNumberProviderJSONRequest {
	
	private Integer UserDesignID;
	private String AppID;
	private String Language;
	private UserTextUserTextJSON UserTextJSON;
	private Integer ProviderJSON;
	...
	public Integer getProviderJSON() {
		return ProviderJSON;
	}

	public void setProviderJSON(Integer providerJSON) {

...
public class UserDesignGetData {
	...
	private List<UserDesignCookieJSON> CookieJSON;
	private List<UserDesignProviderJSON> ProviderJSON;
	private List<UserDesignCategoryJSON> CategoryJSON;

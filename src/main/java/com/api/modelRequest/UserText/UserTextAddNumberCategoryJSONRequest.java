...
public class UserTextAddNumberCategoryJSONRequest {
	...
	public Integer getCategoryJSON() {
		return CategoryJSON;
	}

	public void setCategoryJSON(Integer categoryJSON) {
